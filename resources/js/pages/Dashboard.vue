  ...
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <div
        v-for="stat in stats"
        :key="stat.title"
        class="bg-gray-800 bg-opacity-40 backdrop-blur-md border border-gray-700/50 rounded-lg p-6 flex items-center justify-between hover:shadow-xl transition transform hover:-translate-y-1"
      >
        <div>
...
const stats = ref([
  { title: 'Total Products', value: 150, icon: ShoppingBagIcon, bgColor: 'bg-rose-600' },
